...
document.addEventListener('DOMContentLoaded', function(){
    ...
    tableCategorias = $('#tableCategorias').dataTable( {
        ...
        "ajax":{
            "url": "http://localhost/Proyecto_web//categoria/getCategorias",
            "dataSrc":""
        },
        "columns":[
            {"data":"idcategoria"},
    ...
    formCategoria.onsubmit = function(e) {
        ...
        let ajaxUrl = "http://localhost/Proyecto_web//categoria/setCategoria"; 
...
function fntEditInfo(element,idcategoria){
    ...
    let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    let ajaxUrl = "http://localhost/Proyecto_web//categoria/getCategoria/"+idcategoria;
...
function fntDelInfo(idcategoria){
    Swal.fire({
        ...
        if (result.isConfirmed) { 
            let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = "http://localhost/Proyecto_web//categoria/delCategoria";
