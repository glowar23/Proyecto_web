        ...
        <div class="swiper-slide py-5">
          <div class="row banner-content align-items-center">
            ...
            <div class="content-wrapper col-md-7 p-5 mb-5">
              ...
              <h2 class="banner-title display-1 fw-normal">Los mejores productos para <span class="text-primary">tus
                  mascotas</span>
              </h2>
              <a href="<?= base_url() . '/tienda/categoria/2' ?>"
        ...
        <div class="swiper-slide py-5">
          <div class="row banner-content align-items-center">
            ...
            <div class="content-wrapper col-md-7 p-5 mb-5">
              ...
              <h2 class="banner-title display-1 fw-normal">Los mejores productos para <span class="text-primary">tu
                  Gato</span>
              </h2>
              <a href="<?= base_url() . '/tienda/categoria/1' ?>"
                class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1">
                shop now
                <svg width="24" height="24" viewBox="0 0 24 24" class="mb-1">
                  <use xlink:href="#arrow-right"></use>
