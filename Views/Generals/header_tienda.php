...
<head>
    ...
    <script src="https://kit.fontawesome.com/fccbf69fc7.js" crossorigin="anonymous"></script>
    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <sub style="
              ...
              padding-right:20px;" 
              id="car"><?php
            if(isset($_SESSION['arrIdProductos']))echo count($_SESSION['arrIdProductos']); ?></sub>
        </a>
        <div class="text-end">
        <div class="dropdown">
